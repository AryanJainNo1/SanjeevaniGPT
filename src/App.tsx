...
export default function App() {
  ...
  const sendMessage = async (text: string) => {
    if (!text.trim() || isLoading || !user || !activeConversationId) return;
    ...
    try {
      // Add user message
      await addDoc(collection(db, `users/${user.uid}/conversations/${activeConversationId}/messages`), userMessage);
